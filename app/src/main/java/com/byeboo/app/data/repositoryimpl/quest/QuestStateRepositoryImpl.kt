...
class QuestStateRepositoryImpl
@Inject
constructor(
    private val questStateDataSource: QuestStateDataSource,
    private val userLocalDataSource: UserLocalDataSource
) : QuestStateRepository {
    override suspend fun updateQuestStartState(): Result<Unit> =
        runCatching {
    ...
    override suspend fun getUserJourney(): String? = userLocalDataSource.getJourney()
