        ...
        private fun getDummyAnswers(): ImmutableList<MyAnswerModel> =
            persistentListOf(
                MyAnswerModel(
                    ...
                    content =
                        "헤어진 지 벌써 일주일이 지났습니다. 처음에는 실감이 안 나서 눈물조차 나오지 않았어요. 그저 멍하니 천장만 바라보며 시간을 보냈습니다. " +
                            "그런데 오늘 아침, 습관적으로 휴대폰을 확인하다가 더 이상 '굿모닝' 인사를 보낼 사람이 없다는 사실을 깨닫고 그제야 무너져 내렸습니다. " +
                            "밥알이 모래알 같아서 잘 넘어가지도 않네요. 친구들은 시간이 약이라고, " +
                            "더 좋은 사람 만날 거라고 위로하지만 지금 당장은 그 어떤 말도 귀에 들어오지 않습니다.\n" +
                            "\n" +
                            "우리가 함께 걷던 거리, 자주 가던 카페, 이어폰을 나눠 끼고 듣던 노래들... 세상은 여전히 그대로 굴러가는데 우리 사이만 끊어졌다는 게 도무지 믿기지가 않아요. " +
                            "당신이 사무치게 밉다가도, 당장이라도 달려가 안기고 싶은 내 마음이 너무 싫습니다. 수백 번 차단했다 풀었다를 반복하며 당신의 프로필을 훔쳐보는 내가 너무 초라해 보여요.\n" +
                            "\n" +
